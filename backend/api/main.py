...
from api.safe_response import SafeJSONResponse
...
#
# JWT viaja en Authorization; no usamos cookies de sesión entre orígenes.
# Los orígenes, métodos y headers se enumeran explícitamente.
# ------------------------------------------------------------------------------
app.add_middleware(
    CORSMiddleware,
